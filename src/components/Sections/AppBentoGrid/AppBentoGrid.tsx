import Stats10 from "@/components/Charts/Charts";
    ...
    >
      <div className="border-x mx-5 md:mx-10 relative">
        ...
        <div className="border-b w-full h-full p-10 md:p-14">
          <div className="max-w-xl mx-auto flex flex-col items-center justify-center gap-2">
            <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance pb-1">
              Empower Your Post Sales with AI
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 overflow-hidden">
          <div className="flex flex-col items-start justify-end min-h-[600px] md:min-h-[500px] p-0.5 relative before:absolute before:-left-0.5 before:top-0 before:z-10 before:h-screen before:w-px before:bg-[#e5e5e5] before:content-[''] after:absolute after:-top-0.5 after:left-0 after:z-10 after:h-px after:w-screen after:bg-border after:content-[''] group cursor-pointer max-h-[400px] group">
                          ...
                          >
                            <div>
                              ...
                              >
                                <div>
                                  {/* <p> */}
                                    <TypingAnimation duration={45}>
                                      Based on your calendar patterns and
                                      preferences, I recommend scheduling the
                                      team meeting for Tuesday at 2pm. This time
                                      slot has historically had the highest
                                      attendance rate, and it avoids conflicts
              ...
              <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
                ...
                <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
                  <div className="relative flex h-full w-full items-center justify-center translate-y-0 md:translate-y-32">
                    ...
                    <div
                      className="absolute flex size-[var(--icon-size)] z-20 p-1 transform-gpu animate-orbit items-center justify-center rounded-full [animation-direction:reverse]"
                      style={
                        {
                          "--duration": "20",
                          "--radius": "98",
                    ...
                    <div
                      className="absolute flex size-[var(--icon-size)] z-20 p-1 transform-gpu animate-orbit items-center justify-center rounded-full"
                      style={
                        {
                          "--duration": "40",
                          "--radius": "156.8",
                        ...
                        >
                          ...
                          <defs>
                            ...
                            <linearGradient
                              ...
                              gradientUnits="userSpaceOnUse"
                            >
                              <stop stopColor="#1C7DFF"></stop>
                              <stop
                                offset="0.52021"
                                stopColor="#1C69FF"
                              ></stop>
                              <stop offset="1" stopColor="#F0DCD6"></stop>
                            </linearGradient>
            ...
            <div className="relative flex size-full items-center justify-center h-full overflow-hidden">
              <div className="w-full h-full flex flex-col relative">
                ...
                <div
                  ...
                  style={{
                    opacity: 1,
                    transform: "translateX(276.892px) translateX(-50%)",
                  }}
                ></div>
                <div
                ...
                <div className="w-full absolute grid gap-10 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/3">
                  ...
                  <div
                    ...
                    style={{
                      opacity: 0,
                      transform: "translateX(553.785px)",
                    }}
                  >
